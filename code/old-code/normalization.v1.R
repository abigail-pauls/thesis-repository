...
#final<-subset(final,!is.na(final$prcp.avg)|!is.na(final$prcp.mean)|!is.na(tmax.avg)|!is.na(tmin.avg))
...
a<-final[i,62]
	...
	final$n.tmax.avg[i]<-(final$tmax.avg[i]-norm.tmax[station_id==a,"tmax.avg"])/norm.tmax[station_id==a,"tmax.sd"]
