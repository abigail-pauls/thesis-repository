...
for(i in 1:nrow(final)){
       final$n.prcp.avg[i]<-(final$prcp.avg[i]-norm.prcp$prcp.avg.u[i])/norm.prcp$prcp.avg.sd[i]
       final$n.prcp.mean[i]<-(final$prcp.mean[i]-norm.prcp$prcp.mean.u[i])/norm.prcp$prcp.mean.sd[i]
       ...
       final$n.prcp.xhigh[i]<-(final$prcp.xhigh[i]-norm.prcp$prcp.xhigh.u[i])/norm.prcp$prcp.xhigh.sd[i]
       final$n.prcp.high[i]<-(final$prcp.high[i]-norm.prcp$prcp.high.u[i])/norm.prcp$prcp.xhigh.sd[i]
       final$n.tmax.avg[i]<-(final$tmax.avg[i]-norm.tmax$tmax.avg[i])/norm.tmax$tmax.sd[i]
       ...
       final$n.tmin.avg[i]<-(final$tmin.avg[i]-norm.tmin$tmin.avg[i])/norm.tmin$tmin.sd[i]
       ...
       final$n.tmax.xhigh.length[i]<-(final$tmax.xhigh.length[i]-norm.tmax$tmax.xhigh.length.u[i])/norm.tmax$tmax.xhigh.length.sd[i]
       final$n.tmax.high.length[i]<-(final$tmax.high.length[i]-norm.tmax$tmax.high.length.u[i])/norm.tmax$tmax.high.length.sd[i]
       final$n.tmax.xlow.length[i]<-(final$tmax.xlow.length[i]-norm.tmax$tmax.xlow.length.u[i])/norm.tmax$tmax.xlow.length.sd[i]
       final$n.tmax.low.length[i]<-(final$tmax.low.length[i]-norm.tmax$tmax.low.length.u[i])/norm.tmax$tmax.low.length.sd[i]
       final$n.tmin.xhigh.length[i]<-(final$tmin.xhigh.length[i]-norm.tmin$tmin.xhigh.length.u[i])/norm.tmin$tmin.xhigh.length.sd[i]
	final$n.tmin.high.length[i]<-(final$tmin.high.length[i]-norm.tmin$tmin.high.length.u[i])/norm.tmin$tmin.high.length.sd[i]
	final$n.tmin.xlow.length[i]<-(final$tmin.xlow.length[i]-norm.tmin$tmin.xlow.length.u[i])/norm.tmin$tmin.xlow.length.sd[i]
	final$n.tmin.low.length[i]<-(final$tmin.low.length[i]-norm.tmin$tmin.low.length.u[i])/norm.tmin$tmin.low.length.sd[i]
}
